...
const go = async () => {
  ...
  let details = [new TransactionDetail(1000, 597055555562, utils.buyOrder())];
  ...
  let installmentDetails = [new InstallmentDetail(597055555562, details[0].buyOrder, 3)];
  ...
  let commitDetails = [new CommitDetail(597055555562, details[0].buyOrder)];
