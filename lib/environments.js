const transbankIntegrationCert = require('./certs/transbankIntegrationPublicCert');
const transbankCert = require('./certs/transbankPublicCert');
...
module.exports.TBKEnvironment = class TBKEnvironment {
  constructor() {
